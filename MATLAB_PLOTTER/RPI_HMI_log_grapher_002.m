% RPI_HMI_log_grapher_002 - main diff - time vector
% Seems to produce nicer graphs

%%  Idea is to read in log file, and plot along time axis.
...
%   interval of .5 or more to reduce rounding errors...
%   else matlab plots look jittery - is fixable somehow...
...
%fileID = fopen('2016.12.18_13.45.37_9_LED_prototype_02.csv'); % real long
