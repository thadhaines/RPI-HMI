...
PH_DEBUG = 0      # 1 for random pH, else 0 for serial communication

# Log and Update Variables
log_interval = 1                    # Time between log entries
log_append = "RPI_HMI_v1.0_LOG"     # Name used to make logs more descriptive
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("RPI HMI v1.0")     # Title creation
