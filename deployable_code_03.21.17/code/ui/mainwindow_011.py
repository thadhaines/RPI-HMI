...
''' Global Variables '''
# Debug flags
ADC_DEBUG = 1     # 1 for random temps, else 0 for ADC collection
...
log_append = "RPI_HMI_DEBUG_LOG"    # Name used to make logs more descriptive
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("RPI HMI - Full Debug")     # Title creation
